<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Access.aspx.cs" Inherits="Frontend.Admin.Access" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        function bindCity() {
           ...
           __doPostBack('<%=rptAccessList.UniqueID %>', '');
        }
        </script>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Add Access</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <asp:Repeater ID="rptAccessList" runat="server">
                                    <HeaderTemplate>
